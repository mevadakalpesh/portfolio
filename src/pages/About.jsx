          ...
          <div className="about-content">
            ...
            <div className="about-text">
              ...
              <p>
                ...
                <br /> 
                <br /> 
                I'm <span>Mevada Kalpesh</span>, your trusted <span>Full Stack
                Software Engineer </span> with a knack for turning ideas into seamless digital
                solutions.
              </p>
              <br />
              <p>
              With over <span> 4 years of hands-on experience </span>, I've delved deep into
              the realms of <span> Laravel, Vue, and React, </span> crafting efficient and elegant solutions
              that elevate user experiences. From backend magic in Laravel to dynamic
              frontends with Vue and React, I've got you covered.
             </p>
             <br />
              <p>
              Driven by a <span> passion </span> for innovation, I'm constantly learning and
              adapting to stay ahead of the curve. Whether it's <span> mastering </span> new technologies
              or refining existing skills, I'm committed to delivering top-notch results every
              time.
             </p>
             <br />
             <p> Let's <span> collaborate </span> and bring your vision to
               life with cutting-edge technology and unparalleled expertise.
               <span>Get in touch</span> , and let's build something extraordinary together!</p>
